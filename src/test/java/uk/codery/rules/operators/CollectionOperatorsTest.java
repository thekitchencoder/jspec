...
class CollectionOperatorsTest {
    ...
    void in_withMatchingStringValue_shouldMatch() {
        ...
        Rule rule = new Rule("test", Map.of("status", Map.of("$in", List.of("ACTIVE", "PENDING"))));
    ...
    void in_withMatchingIntegerValue_shouldMatch() {
        ...
        Rule rule = new Rule("test", Map.of("age", Map.of("$in", List.of(18, 25, 30, 40))));
    ...
    void in_withSingleElementList_shouldWork() {
        Map<String, Object> doc = Map.of("status", "ACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$in", List.of("ACTIVE"))));
    ...
    void in_withEmptyList_shouldNotMatch() {
        Map<String, Object> doc = Map.of("status", "ACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$in", List.of())));
    ...
    void in_withNonListOperand_shouldNotMatch() {
        Map<String, Object> doc = Map.of("status", "ACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$in", "ACTIVE")));
    ...
    void in_withMixedTypes_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("value", Map.of("$in", List.of("42", 42, true))));
    ...
    void nin_withNonMatchingValue_shouldMatch() {
        Map<String, Object> doc = Map.of("status", "INACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$nin", List.of("ACTIVE", "PENDING"))));
    ...
    void nin_withEmptyList_shouldMatch() {
        Map<String, Object> doc = Map.of("status", "ACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$nin", List.of())));
    ...
    void nin_withIntegers_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("age", Map.of("$nin", List.of(18, 25, 30))));
    ...
    void nin_withNonListOperand_shouldNotMatch() {
        Map<String, Object> doc = Map.of("status", "INACTIVE");
        Rule rule = new Rule("test", Map.of("status", Map.of("$nin", "ACTIVE")));
    ...
    void all_withAllElementsPresent_shouldMatch() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of("admin", "user"))));
    ...
    void all_withMissingElement_shouldNotMatch() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of("admin", "verified"))));
    ...
    void all_withEmptyQueryList_shouldMatch() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of())));
    ...
    void all_withEmptyDocumentList_shouldNotMatch() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of("admin"))));
    ...
    void all_withNonListOperand_shouldNotMatch() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", "admin")));
    ...
    void all_withDuplicatesInQueryList_shouldWork() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of("admin", "admin"))));
    ...
    void all_withIntegers_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("numbers", Map.of("$all", List.of(2, 4))));
    ...
    void size_withMatchingSize_shouldMatch() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$size", 2)));
    ...
    void size_withNonMatchingSize_shouldNotMatch() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$size", 3)));
    ...
    void size_withNonListValue_shouldNotMatch() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of("$size", 1)));
    ...
    void size_withLargeList_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("numbers", Map.of("$size", 10)));
    ...
    void size_withDoubleOperand_shouldWork() {
        Map<String, Object> doc = Map.of("tags", List.of("admin", "user"));
        Rule rule = new Rule("test", Map.of("tags", Map.of("$size", 2.0)));
    ...
    void combined_allAndSize_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of(
    ...
    void in_withNestedValues_shouldWork() {
        ...
        Rule rule = new Rule("test", Map.of("nested", Map.of("status", Map.of("$in", List.of("ACTIVE", "PENDING")))));
    ...
    void all_orderDoesNotMatter_shouldMatch() {
        ...
        Rule rule = new Rule("test", Map.of("tags", Map.of("$all", List.of("verified", "admin"))));
