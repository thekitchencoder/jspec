...
class ComparisonOperatorsTest {
    ...
    void eq_withNonMatchingIntegers_shouldNotMatch() {
        Map<String, Object> doc = Map.of("age", 25);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$eq", 30)));
    ...
    void eq_withMatchingStrings_shouldMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("name", Map.of("$eq", "John")));
    ...
    void eq_withMatchingBooleans_shouldMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("active", Map.of("$eq", true)));
    ...
    void eq_withMatchingDoubles_shouldMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("price", Map.of("$eq", 19.99)));
    ...
    void ne_withDifferentValues_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 25);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$ne", 30)));
    ...
    void ne_withSameValues_shouldNotMatch() {
        Map<String, Object> doc = Map.of("age", 25);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$ne", 25)));
    ...
    void ne_withBooleans_shouldMatch() {
        Map<String, Object> doc = Map.of("active", true);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("active", Map.of("$ne", false)));
    ...
    void gt_withLargerValue_shouldMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gt", 25)));
    ...
    void gt_withDoubles_shouldMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("price", Map.of("$gt", 19.99)));
    ...
    void gt_withMixedIntegerAndDouble_shouldWork() {
        Map<String, Object> doc = Map.of("age", 30);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gt", 25.5)));
    ...
    void gt_withStrings_shouldWork() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("name", Map.of("$gt", "Alice")));
    ...
    void gt_withNonComparableTypes_shouldNotMatch() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("value", Map.of("$gt", 10)));
    ...
    void gte_withLargerValue_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 30);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gte", 25)));
    ...
    void gte_withDoubles_shouldWork() {
        Map<String, Object> doc = Map.of("price", 19.99);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("price", Map.of("$gte", 19.99)));
    ...
    void lt_withSmallerValue_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 20);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$lt", 25)));
    ...
    void lt_withNegativeNumbers_shouldWork() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("temperature", Map.of("$lt", 0)));
    ...
    void lte_withSmallerValue_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 20);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$lte", 25)));
    ...
    void combined_gteAndLte_withinRange_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 25);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gte", 18, "$lte", 65)));
    ...
    void combined_gtAndLt_withinRange_shouldMatch() {
        Map<String, Object> doc = Map.of("age", 25);
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gt", 18, "$lt", 65)));
    ...
    void comparison_withMissingField_shouldBeUndetermined() {
        Map<String, Object> doc = Map.of("name", "John");
        QueryCriterion criterion = new QueryCriterion("test", Map.of("age", Map.of("$gt", 18)));
    ...
    void comparison_withVeryLargeNumbers_shouldWork() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("value", Map.of("$gt", 1000000)));
    ...
    void comparison_withZero_shouldWork() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("value", Map.of("$eq", 0)));
    ...
    void comparison_withDecimalPrecision_shouldWork() {
        ...
        QueryCriterion criterion = new QueryCriterion("test", Map.of("price", Map.of("$gt", 10.0)));
